...
\begin{proof}
  ...
  Now clearly, $\{U_i \cap K\}_{i \in I}$ is an open cover of $K$, so by compactness there are $i_1, \dots, i_n$ so that $\{U_{i_1} \cap K, \dots, U_{i_n} \cap K\}$ cover $K$ by compactness. In particular, $K \subset U_{i_1} \cup \dots \cup U_{u_n}$. Now
  \[
