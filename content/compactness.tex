...
\end{proof}
\begin{thm}
  Let $X$ and $Y$ be topological spaces, assume that $X$ is compact, and let $f : X \to Y$ be a continuous map. Then the image $f(X) \subset Y$ is compact. If furthermore $Y$ is Hausdorff, and $f$ is a bijection, then the inverse map $f^{-1} : Y \to X$ is continuous.
\end{thm}
\begin{proof}
  ...
  Assume now that $Y$ is Hausdorff and $f$ is bijective. To show that $f^{-1}$ is continuous, let $U \subset X$ be open, and let us show that $f(U)$ is also open. To do so, note that $U^c$ is closed and thus compact by Theorem~\ref{closed-in-compact}.
\end{proof}
