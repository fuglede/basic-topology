...
\end{prop}
\begin{proof}
  The strategy will be to construct a map $f: D^n / \dd D^n \to S^n$ explicitly and then apply the last part of Theorem~\ref{funcs-compact}.
  
  First of all, notice that $D^n$ is closed and bounded, thus compact by the Heine--Borel theorem. Therefore $D^n / \dd D^n$ is compact since quotients of compact spaces are compact. On the other hand, $S^n$ is Hausdorff because it is a subspace of a Hausdorff space. It therefore suffices to construct $f$, and show that it is a continuous bijection.
