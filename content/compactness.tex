...
\begin{defn}
  A topological space is called \word{sequentially compact}{f{\"o}ljdkompakt} if every sequence in it has a convergent subsequence.
\end{defn}
\trans{sequentially compact}{f{\"o}ljdkompakt}
...
\begin{defn}
  A continuous map $f : X \to Y$ is called \word{proper}{?}{proper map}{?} if $f^{-1}(K)$ is compact, whenever $K \subset Y$ is compact.
\end{defn}
\trans{proper map}{?}
\begin{prop}
