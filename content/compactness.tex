...
In this section we will see how we can turn a Hausdorff space into a compact space by adding one more point, and we will see how the new space is Hausdorff at self, as long as it looks sufficiently much like a compact space close to points.
\begin{defn}
