...
\begin{example}
  ...
  At this point it is worth mentioning the existence of \cite{SS}, the standard reference for answers to questions of the form ``What topological space has property $A$ but not property $B$?''.
\end{example}
\begin{defn}
