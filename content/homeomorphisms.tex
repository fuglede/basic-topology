...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{fundamental-polygon-torus}
  \captionof{figure}{Illustration of $X = [0,1] \times [0,1]/\sim$.}
  \label{fundamental-polygon-torus}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{figure-torus}
  \captionof{figure}{The resulting space $S^1 \times S^1$.}
  \label{figure-torus}
\end{minipage}
\end{figure}
