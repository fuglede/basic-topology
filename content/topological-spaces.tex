...
\begin{proof}
  ...
  Assume for the converse that (2) holds, and let $U \in \calT$, and let $x \in U$ be any element. Then there is a $B \in \calB$ with $x \in B \subset U$, and by (2) we get $B' \in \calB'$ with $x \in B' \subset B \subset U$, but by definition of $\calT'$, this says that $U \in \calT'$, so $\calT \subset \calT'$, which shows (1).
\end{proof}
