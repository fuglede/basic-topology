...
\]
We need to check that $\gamma_1 \star \gamma_2$ is actually continuous. This, however follows directly from the closed-set version of the pasting lemma, see Remark~\ref{pasting-closed}.
