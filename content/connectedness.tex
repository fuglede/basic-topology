...
\]
\begin{lem}
  The concatenation of two paths in a topological space $X$ is continuous; the claim then follows from Theorem~\ref{continuous-props}. Let $F \subset X$ be closed.
\end{lem}
\begin{proof}
  We will show that the preimage of any closed set is closed.
\end{proof}
