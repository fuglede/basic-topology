...
%\electronic{\usepackage[colorlinks=true,urlcolor=black,citecolor=black,linkcolor=black]{hyperref}}{\usepackagecolorlinks=true,urlcolor=darkblue,citecolor=darkgreen,linkcolor=darkblue]{hyperref}}
...
\newcommand{\word}[2]{\emph{#1}\index{#1}\addtolist{\alist}{#1#2,}\expandafter\gdef\csname#1#2\endcsname{#1&#2\cr\relax}\lst@BubbleSort{\alist}}
